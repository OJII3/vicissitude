...
- `docs/ARCHITECTURE.md`: モジュール構成、DI 方針、データモデル、主要シーケンス、設計判断（**構成の正本**）
- `docs/PLAN.md`: 未着手/進行中の計画、DoD
- `docs/RUNBOOK.md`: 常時遵守ルール、実行手順（デプロイ詳細含む）、失敗時対応、変更管理
- `docs/STATUS.md`: 既知バグ、直近タスク、ブロッカー
- `docs/CHANGELOG.md`: 完了済みマイルストーン、タスク、設計判断の記録
